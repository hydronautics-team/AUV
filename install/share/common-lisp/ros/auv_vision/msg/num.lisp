...
(cl:defmethod cl:initialize-instance :after ((m <num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name auv_vision-msg:<num> is deprecated: use auv_vision-msg:num instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader auv_vision-msg:num-val is deprecated.  Use auv_vision-msg:num instead.")
  (num m))
